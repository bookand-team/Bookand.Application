...
const BookstoreCon({ Key? key,required this.bookstore }) : super(key: key);
  ...
  final TextStyle titleStyle = const TextStyle(fontSize: 15,color: Color(0xff222222));
  final TextStyle locationStyle = const TextStyle(fontSize: 12,color: Color(0xff666666));
  @override
  ...
  child: Image.network('',width: imageSize.width,height: imageSize.height,)
), Text(bookstore.name!,style: titleStyle,),
  Row(children: [Image.asset(locationAssetPath,width: iconSize.width,height: iconSize.height,),
  Text('test',style: locationStyle,)],)
