...
class NotificationRepositoryImpl implements NotificationRepository {
  ...
  @override
  Future<NotificationModel> getNotificationList(int cursorId, int size) async {
    try {
      final accessToken = await tokenLocalDataSource.getAccessToken();
      return await notificationRemoteDataSource.getNotificationList(accessToken, cursorId, size);
    } on Response catch (e) {
      throw ErrorResponse.fromJson(Utf8Util.utf8JsonDecode(e.bodyString));
    } catch (_) {
      rethrow;
